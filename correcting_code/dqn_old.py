...
num_actions = 11    #multibranch
maxlen = 10         #nsc max seq len (defined at /home/carolina/Documentos/NAS/nas_code/NAS_iterativo/problems/auto_multi_branch/search_space.yml)
...
def create_q_model():
    ...
    layer0 = keras.backend.expand_dims(inputs, axis=-1)

    # Convolutions on the frames on the screen
    layer1 = layers.Conv1D(32, 8, activation="relu", padding="valid")(layer0)
    layer2 = layers.Conv1D(64, 3, activation="relu", padding="valid")(layer1)
    layer3 = layers.Conv1D(64, 1, activation="relu", padding="valid")(layer2)
